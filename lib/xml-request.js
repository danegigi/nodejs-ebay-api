...
exports.xmlRequest = function(options, callback) {
  ...
  options.reqOptions = _.extend({
    ...
    agentOptions: {
      ...
      // Update: eBay required all connection to use TLS 1.2+
      // check: https://nodejs.org/api/tls.html
      // write EPROTO 281473698480288:error:1409442E:SSL routines:ssl3_read_bytes:tlsv1 alert protocol version:../deps/openssl/openssl/ssl/record/rec_layer_s3.c:1546:SSL alert number 70
      minVersion: 'TLSv1.2' // use tls v1.2 and above
    },
  }, options.reqOptions);
